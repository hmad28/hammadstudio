...
const faqs = [
  ...
  { question: "Berapa harga pembuatan landing page?", answer: "Website Starter mulai Rp499.000 untuk scope standar maksimal lima halaman utama. Harga final mengikuti kebutuhan copy, visual, form, analytics, integrasi, dan kompleksitas campaign." },
