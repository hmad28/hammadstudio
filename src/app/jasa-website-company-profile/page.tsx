  ...
  return (
    <>
      ...
      <SEOServicePage
        ...
        faqs={companyFaqs}
        startingPrice="Website Starter mulai Rp 499 ribu dan Website + CMS mulai Rp 899 ribu. Multilingual, document center, dan integrasi mengikuti scope."
        relatedLinks={[{ href: "/redesign-website", label: "Redesign Website", description: "Revamp struktur, desain, performa, dan SEO website perusahaan lama." }, { href: "/maintenance-website", label: "Maintenance & Support", description: "Ownership teknis setelah website diluncurkan." }, { href: "/solusi/perusahaan/sistem-custom-dashboard", label: "Dashboard Custom", description: "Portal dan sistem untuk workflow perusahaan yang lebih spesifik." }]}
