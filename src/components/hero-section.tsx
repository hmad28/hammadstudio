      ...
      <div className="site-container relative z-10">
        ...
        <div className="mx-auto max-w-[880px] pb-12 pt-10 text-center lg:pb-16 lg:pt-14">
          ...
          >
            ...
            <Link href="#work" className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-6 py-3.5 text-xs font-medium text-white shadow-lg backdrop-blur-md transition-all hover:bg-white hover:text-black sm:text-sm">
        ...
        >
            ...
            <div className="relative h-full w-full overflow-hidden rounded-[14px]">
              ...
              <div className="absolute inset-x-0 bottom-0 flex items-end justify-between bg-gradient-to-t from-[#06050b] via-[#06050b]/60 to-transparent p-5 pt-16 sm:p-7 sm:pt-24">
                <div>
                  ...
                  <p className="mt-2 text-base font-semibold text-white sm:text-xl">Saudi Education Expo</p>
                </div>
          ...
          <div className="absolute bottom-[4%] left-[10%] right-[10%] h-[25%] rounded-[50%] bg-gradient-to-r from-[#8b5cf6]/25 via-[#cfef57]/20 to-[#6366f1]/25 blur-3xl" aria-hidden="true" />
        </motion.div>
      </div>
    </section>
  );
