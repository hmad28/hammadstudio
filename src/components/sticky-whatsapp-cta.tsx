...
export function StickyWhatsAppCTA() {
  return (
    <a
      ...
      className="global-whatsapp-float whatsapp-float group fixed bottom-4 right-4 z-[55] flex h-14 items-center justify-center rounded-full border border-white/35 bg-[#25d366] px-4 text-white shadow-[0_16px_45px_rgba(10,92,48,.38)] transition duration-300 hover:-translate-y-1 hover:bg-[#20c45c] hover:shadow-[0_22px_55px_rgba(10,92,48,.5)] sm:bottom-6 sm:right-6 sm:h-16 sm:gap-3 sm:px-5"
