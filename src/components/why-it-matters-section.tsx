  ...
  return (
    <section id="why-it-matters" className="scroll-mt-20 bg-[#e6e4de] py-20 text-[#0a0a09] sm:py-28 lg:py-32">
      <div className="site-container">
        <MotionReveal className="surface-card grid overflow-hidden rounded-2xl bg-[#eceae4] border border-[#deddd5] lg:grid-cols-12">
          {/* Left: Beautiful Website Mockup */}
          <div className="relative min-h-[380px] overflow-hidden bg-[#0b0b0a] sm:min-h-[500px] lg:col-span-6">
            <Image
            ...
            <div className="absolute inset-x-6 bottom-6 flex items-end justify-between text-white">
              <div>
                <span className="label-mono text-white/55">Website Experience</span>
                <p className="mt-1 text-lg font-semibold sm:text-xl">Saudi Education Expo</p>
              </div>
              <span className="rounded-full bg-[#cfef57] px-3.5 py-1.5 text-xs font-semibold text-black">
                2026
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center p-8 sm:p-12 lg:col-span-6 lg:p-14">
            ...
            <p className="mt-5 text-sm leading-[1.65] text-black/60 sm:text-base">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {copy.items.map((item) => {
                ...
                return (
                  <div key={item.title} className="rounded-xl border border-black/10 bg-white/60 p-4">
