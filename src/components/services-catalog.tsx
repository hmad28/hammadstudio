...
const content = {
  ...
  discuss: { id: "Diskusikan kebutuhan", en: "Discuss your needs" },
  services: [
    {
      number: "01",
        ...
        {content.services.map((service) => (
          <MotionReveal key={service.number} className="grid gap-8 border-b border-black/15 py-12 sm:py-16 lg:grid-cols-12 lg:gap-6">
            ...
            <div className="lg:col-span-6">
              ...
              <Link href="mailto:hello@hammad.studio" className="group mt-8 inline-flex items-center gap-2 text-sm font-semibold">{content.discuss[locale]} <ArrowUpRightIcon className="button-arrow h-4 w-4" /></Link>
            </div>
          </MotionReveal>
        ))}
      </div>
